...
export default function PlayerInput({ handleSubmit }: { handleSubmit: (input: string) => void | Promise<void> }) {
  ...
  return (
    <div className="flex flex-col w-full gap-2 pt-2 bg-white items-center justify-center">
      <motion.div
      ...
      >
        <input
          ...
          disabled={isDisabled}
          className="pb-10! disabled:bg-zinc-200! disabled:text-zinc-400!"
        />
        <button
      ...
      <div className="flex gap-2 justify-end w-full text-sm items-start">
